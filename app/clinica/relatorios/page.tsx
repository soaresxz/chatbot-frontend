...
import { Bot, MessageSquare, TrendingUp, Clock, RefreshCw } from "lucide-react"
      ...
      <div className="flex flex-col gap-6">
        ...
        {!loading && data && (
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <Card>
              <CardHeader className="pb-2">
                <CardTitle className="text-sm font-medium text-muted-foreground">Conversas do Mês</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="text-2xl font-bold">{data.conversas_mes}</div>
          ...
          <div className="grid gap-4 lg:grid-cols-2">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Hoje · Semana · Mês</CardDescription>
              </CardHeader>
              <CardContent>
                <div className="h-64">
